...
import com.abarrotes.entidades.*;
...
public class SucursalDto implements Serializable {
    ...
    public Integer getUsuarioList() {
        return usuarioList;
    }

    public void setUsuarioList(Integer usuarioList) {
    ...
    public String toString() {
        return "Sucursal{" + "idSucursalPk=" + idSucursalPk + ", nombre=" + nombre + ", direccion=" + direccion + ", cp=" + cp + ", telefono=" + telefono + ", estatus=" + estatus + ", idEmpresaFk=" + idEmpresaFk + ", usuarioList=" + usuarioList + '}';
    }
