...
public class EmpresaDto implements Serializable {
    ...
    public Integer getSucursalList() {
        return sucursalList;
    }

    public void setSucursalList(Integer sucursalList) {
    ...
    public String toString() {
        return "com.abarrotes.entidades.Empresa[ idEmpresaPk=" + idEmpresaPk + " ]";
    }
