...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByMandarMensajePromocion", query = "SELECT c FROM Cliente c WHERE c.mandarMensajePromocion = :mandarMensajePromocion")})
public class Cliente implements Serializable {
    ...
    @Column(name = "mandar_mensaje_promocion")
    private Integer mandarMensajePromocion;
    ...
    public Integer getMandarMensajePromocion() {
        return mandarMensajePromocion;
    }

    public void setMandarMensajePromocion(Integer mandarMensajePromocion) {
        this.mandarMensajePromocion = mandarMensajePromocion;
    }
    ...
    public String toString() {
        return "com.abarrotes.entidades.Cliente[ idClientePk=" + idClientePk + " ]";
    }
